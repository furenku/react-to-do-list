  ...
  render() {
    ...
    return (
      <div className="To-Do-List">
        ...
        <p>Añade tareas y márcalas como terminadas o elimínalas. Se almacenan en localStorage. Prueba recargando tu ventana una vez que hayas añadido algunas tareas.</p>
        ...
        <footer>
          <a
          href="https://github.com/furenku/react-to-do-list"
          target="_blank"
          >
            <span>
              Código fuente
